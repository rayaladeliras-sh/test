...
public class GetterSetterTester {
    ...
    private void testGetterAndSetter(final Field field, final Object instance) {
        ...
        try {
            ...
            Assert.assertEquals(getter.invoke(instance), value, "Failed getter and setter test of field "
                    + field.getName() + " on classs "
                    + field.getDeclaringClass().getName());

        } catch (Exception e) {
          e.printStackTrace();
          Assert.fail(" exception thrown on field: " + field.getName());
        }
    ...
    private void testSetter(final Field field, final Object instance) {
        ...
        try {
            ...
            Assert.assertEquals(field.get(instance), value, "Failed setter test of field "
                    + field.getName() + " on classs "
                    + field.getDeclaringClass().getName());
    ...
    private void testGetter(final Field field, final Object instance) {
        ...
        try {
            ...
            Assert.assertEquals(getter.invoke(instance), value, "Failed getter test of field "
                    + field.getName() + " on classs "
                    + field.getDeclaringClass().getName());
