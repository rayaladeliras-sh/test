...
import com.stubhub.domain.inventory.listings.v2.tns.tasks.FraudStatusUpdateTask;
...
public class FraudEvaluationListingUpdateListener implements MessageListener {
	...
	public void onMessage(Message message) {
		DyeUtil.beginDyedOperation("FraudEvaluationListingUpdateListener");
	...
	private FraudStatusUpdateRequest buildUpdateRequest(MapMessage mapMsg) throws NumberFormatException, JMSException {
		...
		String fraudCheckStatusId = mapMsg.getString("fraudCheckStatusId");
		String fraudCheckStatus = mapMsg.getString("fraudCheckStatus");
		String sellerId = mapMsg.getString("sellerId");
		String fraudResolutionId = mapMsg.getString("fraudResolutionId");
		String isSellerDeactivated = mapMsg.getString("isSellerDeactivated");
//		String deactivationReasonId = mapMsg.getString("userDeactivationReasonId");
		log.info(
				"api_domain={}, api_method={}, calling, listingId={}, fraudCheckStatusId={}, fraudCheckStatus={}, sellerId={}, fraudResolutionId={}, isSellerDeactivated={} ",
				DOMAIN, "fraudEvaluationListingUpdate", listingId, fraudCheckStatusId, fraudCheckStatus, sellerId,
		...
		if (StringUtils.isNumeric(listingId)) {
			...
			log.error(
					"api_domain={}, api_method={}, message=Invalid Listing ID, listingId={}, fraudCheckStatusId={}, fraudCheckStatus={}, sellerId={}, fraudResolutionId={}, isSellerDeactivated={} ",
					DOMAIN, "fraudEvaluationListingUpdate", listingId, fraudCheckStatusId, fraudCheckStatus, sellerId,
					fraudResolutionId, isSellerDeactivated );
		}
		if (StringUtils.isNumeric(fraudCheckStatusId)) {
			request.setFraudCheckStatusId(Long.valueOf(fraudCheckStatusId));
		} else {
			validationFlag = false;
			log.error(
					"api_domain={}, api_method={}, message=Invalid FraudCheckStatus ID, listingId={}, fraudCheckStatusId={}, fraudCheckStatus={}, sellerId={}, fraudResolutionId={}, isSellerDeactivated={} ",
					DOMAIN, "fraudEvaluationListingUpdate", listingId, fraudCheckStatusId, fraudCheckStatus, sellerId,
					fraudResolutionId, isSellerDeactivated);
		}
		if (StringUtils.isNumeric(sellerId)) {
			...
			log.info(
					"api_domain={}, api_method={}, message=Seller ID is invalid, listingId={}, fraudCheckStatusId={}, fraudCheckStatus={}, sellerId={}, fraudResolutionId={}, isSellerDeactivated={} ",
					DOMAIN, "fraudEvaluationListingUpdate", listingId, fraudCheckStatusId, fraudCheckStatus, sellerId,
					fraudResolutionId, isSellerDeactivated );
		}
		if (StringUtils.isNumeric(fraudResolutionId)) {
			...
			log.info(
					"api_domain={}, api_method={}, message=Fraud Resolution ID is invalid, listingId={}, fraudCheckStatusId={}, fraudCheckStatus={}, sellerId={}, fraudResolutionId={}, isSellerDeactivated={} ",
					DOMAIN, "fraudEvaluationListingUpdate", listingId, fraudCheckStatusId, fraudCheckStatus, sellerId,
					fraudResolutionId, isSellerDeactivated );
		}
		request.setIsSellerDeactivated(Boolean.parseBoolean(isSellerDeactivated));
		request.setFraudCheckStatus(fraudCheckStatus);
		if (!validationFlag) {
			log.info(
					"api_domain={}, api_method={}, message=\"Fraud Status Update Validation Fail\" listingId={}, fraudCheckStatusId={}, fraudCheckStatus={}, sellerId={}, fraudResolutionId={}, isSellerDeactivated={} ",
					DOMAIN, "onMessage", listingId, fraudCheckStatusId, fraudCheckStatus, sellerId, fraudResolutionId,
					isSellerDeactivated );
